...
rel_diff <- (missing_cov_mean-all_cov_mean)/all_cov_mean %>% as.data.frame() 
...
# missing values will be assigned with knn Imputation for the glmnet model. 
...
confusionMatrix(glmnet_pred, cov_test$outcome, positive = "dead")
...
for (nfeature in 1:4){
  ...
  # bug in the glmnet, it requiers an additional column
